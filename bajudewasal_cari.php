  ...
  <div class="container">
    <div class="page-header_wrap">
      <div class="page-heading">
        <h1>Daftar Paket Pernikahan Gedung</h1>
      </div>
      <ul class="coustom-breadcrumb">
        <li><a href="#">Home</a></li>
        <li>Daftar Paket Pernikahan Gedung</li>
      </ul>
    </div>
  </div>
      ...
      <div class="col-md-9 col-md-push-3">
        <div class="result-sorting-wrapper">
          <div class="sorting-count">
			...
			?>
			<p><span><?php echo htmlentities($cnt);?> Paket Ditemukan</span></p>
			</div>
		</div>
...
?>
	...
	<!-- 	<div class="sidebar_widget">
          <div class="widget_heading">
            <h5><i class="fa fa-filter" aria-hidden="true"></i>Cari Paket</h5>
          </div>
        ...
        <div class="sidebar_widget">
          <div class="widget_heading">
            <h5><i class="fa fa-clothes" aria-hidden="true"></i>Paket Terbaru</h5>
          </div>

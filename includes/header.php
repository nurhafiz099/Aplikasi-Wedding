    ...
    <div class="container">
      <div class="row">
        <div class="col-sm-3 col-md-3">
          <div class="logo"><a href="index.php"><img src="admin/img/icon.png" width="120px" height="90px" alt="image"/></a> </div>
        </div>
        <div class="col-sm-8 col-md-8">
          <div class="header_info">
            <div class="header_widgets">
              ...
              <a href="mailto:ask@menaratnt.com">WDProject@gmail.com</a> </div>
            <div class="header_widgets">
	 ...
	 <i class="fa fa-angle-down" aria-hidden="true"></i></a>
      ...
      <div class="collapse navbar-collapse" id="navigation">
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown"  bgcolor="blue"> <a href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Paket Pernikahan Rumah</a>
			<ul class="dropdown-menu">
				<li><a href="bajuanakp.php">Paket Ekonomis</a></li>
				<li><a href="bajuanakl.php">Paket Spesial</a></li>
			</ul>
          </li>
          <li class="dropdown"  bgcolor="blue"> <a href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Paket Pernikahan Gedung</a>
			<ul class="dropdown-menu">
				<li><a href="bajudewasap.php">Paket Ekonomis</a></li>
				<li><a href="bajudewasal.php">Paket Spesial</a></li>
			</ul>
          </li>

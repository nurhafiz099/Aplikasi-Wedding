						...
						<div class="row">
							<div class="col-md-12">
								<div class="panel panel-default">
											...
											<div class="col-sm-4">
												<select class="form-control" name="kategori" required>
													<?php
														...
														echo "<option value='Anak Laki-Laki'>Rumah Spesial</option>";
														echo "<option value='Anak Perempuan'>Rumah Ekonomis</option>";
														echo "<option value='Dewasa Laki-Laki'>Gedung Spesial</option>";
														echo "<option value='Dewasa Perempuan'>Gedung Ekonomis</option>";
													?>
												</select>
											</div>
										</div>
									...
									<div class="form-group">
										<div class="col-sm-12">
											<h4 align="center"><b>Gambar Paket</b></h4>
										</div>
									</div>
									<div class="form-group">
										<div class="col-sm-4">

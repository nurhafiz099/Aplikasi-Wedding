							...
							<div class="panel panel-default">
								...
								<div class="panel-body">
									...
									<div class="form-group">
										...
										<label class="col-sm-2 control-label">Jenis Paket<span style="color:red">*</span></label>
										<div class="col-sm-4">
									...
									<div class="form-group">
										<label class="col-sm-2 control-label">Deskripsi Paket<span style="color:red">*</span></label>
										<div class="col-sm-4">
										...
										<div class="col-sm-4">
											<select class="form-control" name="kategori" required>
												...
												<option value="Anak Laki-Laki">Rumah Spesial</option>
												<option value="Anak Perempuan">Rumah Ekonomis</option>
												<option value="Dewasa Laki-Laki">Gedung Spesial</option>
												<option value="Dewasa Perempuan">Gedung Ekonomis</option>
											</select>
										</div>
									</div>
									...
									<div class="form-group">
										<div class="col-sm-12">
											<h5 align="center"><b>Ukuran Undangan</b></h5>
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-1 control-label">300 undangan<span style="color:red">*</span></label>
										<div class="col-sm-2">
											<input type="number" min="0" name="s" class="form-control" required>
										</div>
										<label class="col-sm-1 control-label">400 undangan<span style="color:red">*</span></label>
										<div class="col-sm-2">
											<input type="number" min="0" name="m" class="form-control" required>
										</div>
										<label class="col-sm-1 control-label">500 undangan<span style="color:red">*</span></label>
										<div class="col-sm-2">
											<input type="number" min="0" name="l" class="form-control" required>
										</div>
										<label class="col-sm-1 control-label">600 undangan<span style="color:red">*</span></label>
										<div class="col-sm-2">

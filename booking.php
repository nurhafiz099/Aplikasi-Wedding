...
return true;
	...
	<div class="user_profile_info">	
        ...
        <form method="post" name="sewa" onSubmit="return valid();"> 
			...
			<div class="form-group">
			<label>Ukuran Undangan</label><br/>
				<select class="form-control" name="ukuran" required>
					<option value="">== Pilih Ukuran ==</option>
					<option value="s">300 undangan</option>
					<option value="m">400 undangan</option>
					<option value="l">500 undangan</option>
					<option value="xl">600 undangan</option>
				</select>
            </div>
			<div class="form-group">
			<label>Metode Konsultasi</label><br/>
				<select class="form-control" name="pickup" required>
					<option value="">== Metode Konsultasi ==</option>
					<option value="Ambil Sendiri">Online</option>
					<option value="Kurir">Datang Langsung</option>
				</select>
            </div>
			<br/>			
			<div class="form-group">
